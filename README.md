About lammps-interface-feedstock
================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/lammps-interface-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/lammps-interface-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add lammps-interface
# for installing globally
pixi global install lammps-interface
```
...
It is possible to list all of the versions of `lammps-interface` available on your platform:
...
```
pixi search lammps-interface --channel conda-forge
```
