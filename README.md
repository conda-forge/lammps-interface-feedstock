...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/lammps-interface-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13680&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/lammps-interface-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `lammps-interface` can be installed with:

```
conda install lammps-interface
```

It is possible to list all of the versions of `lammps-interface` available on your platform with:
